              ...
              <div class="u-layout-row">
                <div class="u-align-right u-container-style u-image u-layout-cell u-size-60 u-image-1" data-image-width="1280" data-image-height="720">
                  <div class="u-container-layout u-container-layout-1">
                    <img class="u-image u-image-default u-preserve-proportions u-image-2" src="images/H1.png" alt="" data-image-width="1000" data-image-height="1000">
                    <img class="u-image u-image-default u-preserve-proportions u-image-3" src="images/p.png" alt="" data-image-width="800" data-image-height="800">
                ...
                <div class="u-container-style u-layout-cell u-right-cell u-size-60 u-white u-layout-cell-2">
                  <div class="u-container-layout u-container-layout-2">
                    ...
                    <div class="u-align-center u-form u-form-1">
                      <form action="./login.php" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
                        
                        <div class="u-form-group">
                          <label for="email-3f87" class="u-label">Account</label>
                          <input type="text" placeholder="Enter your account" id="email-3f87" name="Account" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-8 u-white u-input-1" required="required">
                        </div>
                        ...
                        <div class="u-form-send-message u-form-send-success"> Successed. </div>
                    ...
                    <a href="register_page.php" class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-none u-text-palette-1-base u-btn-2">Register<br>
                    </a>
                  </div>
                </div>
              </div>
